...
// ----------------- DASBOR PETUGAS ABSEN (ISOLASI UTAMA TERPERBAIKI) ----------------- //
...
// ----------------- DASBOR ADMIN SEKOLAH (ISOLASI UTAMA TERPERBAIKI) ----------------- //
app.get('/admin', async (req, res) => {
    // PREFERENSI KETAT: Prioritaskan req.query.userId untuk mengisolasi per tab browser
